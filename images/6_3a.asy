...
// --- Axes ---
draw((tx(-4),ty(0))--(tx(8),ty(0)), black+linewidth(0.6pt), Arrow);
...
label(Label("$S(1, -1)$", fontsize(8pt)), (tx(2.2), ty(0.3)), orange);

// --- Vertex V(0, 0) ---
filldraw(circle((tx(0),ty(0)), 0.12), rgb(0,0.6,0), nullpen);  // green
label(Label("$A(2,1)$", fontsize(8pt)), (tx(0.15), ty(-0.45)), rgb(0,0.6,0));
